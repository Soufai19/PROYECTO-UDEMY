...
int comprobarId(struct empleado empleados[100], int num, int id);
void mostrarMenu(){
...
int alta(struct empleado empleados[100], int num){
    ...
    int existe = comprobarId(empleados, num, emp.id);
...
int baja(struct empleado empleados[100], int num){
    ...
    int existe = comprobarId(empleados, num, id);
